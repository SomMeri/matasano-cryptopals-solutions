package org.meri.matasano.set3.competitors;
 ...
 * 
 */
public class HiroshimaMTRandom extends Random {
     ...
     * behaviour.
     */
    public HiroshimaMTRandom(boolean compatible) {
        super(0L);
        compat = compatible;
     ...
     */
    public HiroshimaMTRandom(long seed) {
        super(seed);
    }
     ...
     */
    public HiroshimaMTRandom(byte[] buf) {
        super(0L);
        setSeed(buf);
    }
     ...
     * @throws IllegalArgumentException if the buffer has zero length.
     */
    public HiroshimaMTRandom(int[] buf) {
        super(0L);
        setSeed(buf);
    }
