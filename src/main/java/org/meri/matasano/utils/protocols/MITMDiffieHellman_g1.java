...
public class MITMDiffieHellman_g1 implements DiffieHellmanConversation  {
  ...
  public MITMDiffieHellman_g1(DiffieHellmanConversation intendedFriend) {
    this.intendedFriendB = intendedFriend;
  }

  public BigInteger initConversation(BigInteger p, BigInteger g, BigInteger publicKey) {
    if (!BigInteger.valueOf(1).equals(g))
      throw new IllegalArgumentException("Attack works only for g=1");
