...
public class MD4  {
  ...
  public MD4(int a, int b, int c, int d) {
    this.a = a;
    this.b = b;
    this.c = c;
    this.d = d;
  ...
  public void update(byte[] b, int offset) {
    int len = b.length;
    int pos = (int) (msgLength % BYTE_BLOCK_LENGTH);
  ...
  public byte[] digest(int fakeLengthOffset) {
    byte[] p = pad(fakeLengthOffset);
    update(p, 0);
    byte[] digest = { (byte) a, (byte) (a >>> 8), (byte) (a >>> 16), (byte) (a >>> 24), 
        (byte) b, (byte) (b >>> 8), (byte) (b >>> 16), (byte) (b >>> 24), (byte) c, (byte) (c >>> 8), 
        (byte) (c >>> 16), (byte) (c >>> 24), (byte) d, (byte) (d >>> 8), (byte) (d >>> 16), 
        (byte) (d >>> 24) };
  ...
  public int digest(byte[] buf, int offset, int len) throws DigestException {
    ...
    System.arraycopy(digest(), 0, buf, offset, destLength);
    return destLength;
  }
  ...
  public byte[] pad(int fakeLengthOffset) {
    ...
    long bits = (msgLength + fakeLengthOffset) << 3; 
