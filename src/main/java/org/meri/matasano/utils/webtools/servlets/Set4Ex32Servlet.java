...
public class Set4Ex32Servlet extends HttpServlet {

  private static final byte[] SECRET_KEY = (new ArrayManips()).createInitializedArray(16, 2); // array of zeros is as secret as anything else 
